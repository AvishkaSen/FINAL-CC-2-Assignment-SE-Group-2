...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            // If a user is logged in, display the navigation bar with the additional options for applicants
        ?>
        ...
        <?php
            ...
            // If a user is logged in, display the navigation bar with the additional options for companies
        ?>
        ...
        <?php
            ...
            // If an admin is logged in, display the navigation bar with the additional options for admins
        ?>
        ...
        <!-- End of About us details section -->
        ...
        <div class="bx1">
            ...
            <div class="cnt1">
                ...
                <h2 class="p-2">Get to know Us !<h2>
